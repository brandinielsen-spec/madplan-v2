...
Plans:
- [x] 08-01-PLAN.md - Week picker in RecipePicker drawer (BUG-04)
- [x] 08-02-PLAN.md - Note field for meal entries (FEAT-01, FEAT-02)
- [x] 08-03-PLAN.md - List/grid view toggle with persistence (UI-01)
